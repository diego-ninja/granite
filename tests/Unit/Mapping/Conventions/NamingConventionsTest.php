...
class NamingConventionsTest extends TestCase
{
    ...
    #[Test]
    public function it_identifies_camel_case_properties(): void
    {
    ...
    #[Test]
    public function it_identifies_pascal_case_properties(): void
    {
    ...
    #[Test]
    public function it_identifies_snake_case_properties(): void
    {
    ...
    #[Test]
    public function it_identifies_kebab_case_properties(): void
    {
    ...
    public function it_normalizes_property_names(string $conventionClass, string $input, string $expectedOutput): void
    {
    ...
    public function it_denormalizes_property_names(string $conventionClass, string $input, string $expectedOutput): void
    {
        /** @var NamingConvention $convention */
        $convention = new $conventionClass();
    ...
    public function it_calculates_match_confidence(string $conventionClass, string $source, string $destination, float $expectedConfidence): void
    {
        /** @var NamingConvention $convention */
        $convention = new $conventionClass();
