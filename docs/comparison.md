...
All examples in this document use the `Granite` base class. `GraniteDTO` was already deprecated before v2.0.0, and `GraniteVO` is deprecated as of v2.0.0. Both will be removed in v3.0.0.
