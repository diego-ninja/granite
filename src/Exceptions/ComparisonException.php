<?php
// ABOUTME: Defines ComparisonException as part of the library exception taxonomy.
// ABOUTME: Owns the ComparisonException boundary within the library exception taxonomy.
