<?php
// ABOUTME: Defines CamelCaseConvention as part of the object mapping pipeline.
// ABOUTME: Owns the CamelCaseConvention boundary between mapping configuration and execution.
