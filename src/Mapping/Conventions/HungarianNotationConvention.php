<?php
// ABOUTME: Defines HungarianNotationConvention as part of the object mapping pipeline.
// ABOUTME: Owns the HungarianNotationConvention boundary between mapping configuration and execution.
