<?php
// ABOUTME: Defines SnakeCaseConvention as part of the object mapping pipeline.
// ABOUTME: Owns the SnakeCaseConvention boundary between mapping configuration and execution.
