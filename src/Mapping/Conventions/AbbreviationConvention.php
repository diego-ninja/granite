<?php
// ABOUTME: Defines AbbreviationConvention as part of the object mapping pipeline.
// ABOUTME: Owns the AbbreviationConvention boundary between mapping configuration and execution.
