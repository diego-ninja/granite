<?php
// ABOUTME: Defines MappingStorageTrait as part of the object mapping pipeline.
// ABOUTME: Owns the MappingStorageTrait boundary between mapping configuration and execution.
