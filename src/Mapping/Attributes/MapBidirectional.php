<?php
// ABOUTME: Defines MapBidirectional as part of the object mapping pipeline.
// ABOUTME: Owns the MapBidirectional boundary between mapping configuration and execution.
