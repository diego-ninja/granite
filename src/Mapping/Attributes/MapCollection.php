<?php
// ABOUTME: Defines MapCollection as part of the object mapping pipeline.
// ABOUTME: Owns the MapCollection boundary between mapping configuration and execution.
