<?php
// ABOUTME: Defines NamingConvention as part of the object mapping pipeline.
// ABOUTME: Owns the NamingConvention boundary between mapping configuration and execution.
