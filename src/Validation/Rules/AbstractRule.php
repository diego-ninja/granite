<?php
// ABOUTME: Defines AbstractRule as part of validation rule definition and execution.
// ABOUTME: Owns the AbstractRule boundary between rule definitions and validation results.
