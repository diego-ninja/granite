<?php
// ABOUTME: Defines ArrayType as part of validation rule definition and execution.
// ABOUTME: Owns the ArrayType boundary between rule definitions and validation results.
