<?php
// ABOUTME: Defines StringType as part of validation rule definition and execution.
// ABOUTME: Owns the StringType boundary between rule definitions and validation results.
